                        ...
                        <catalyst::x-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Team Settings -->
                                    <catalyst::x-dropdown-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}">
                                        {{ __('Team Settings') }}
                ...
                <div class="ml-3 relative">
                    <catalyst::x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <catalyst::x-dropdown-link href="{{ route('profile.show') }}">
                                {{ __('Profile') }}
                            </catalyst::x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <catalyst::x-responsive-nav-link href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Profile') }}
                </catalyst::x-responsive-nav-link>

                @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                    <catalyst::x-responsive-nav-link href="{{ route('api-tokens.index') }}"
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    <!-- Team Settings -->
                    <catalyst::x-responsive-nav-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}"
                                           :active="request()->routeIs('teams.show')">
                        {{ __('Team Settings') }}
                    </catalyst::x-responsive-nav-link>

                    @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                        <catalyst::x-responsive-nav-link href="{{ route('teams.create') }}"
