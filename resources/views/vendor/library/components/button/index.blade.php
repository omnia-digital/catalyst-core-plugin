<button wire:loading.attr="disabled"
        wire:loading.class.remove="bg-primary-500 hover:bg-primary-600 focus:ring-primary"
        ...
        bg-primary-500 hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-light focus:ring-primary']) }}
>
    <div>
