...
>
    ...
    <div x-show="show" class="fixed z-[900] inset-0 overflow-hidden flex items-center justify-center w-full h-full p-4"
         style="display: none;">
