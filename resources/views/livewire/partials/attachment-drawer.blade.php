<div>
    <div class="bg-secondary p7 rounded w-9/12 mx-auto">
        <div x-data="dataFileDnD()"
             class="relative flex flex-col p-4 text-light-text-color border border-neutral-light rounded">
            <div x-ref="dnd"
                ...
                <input accept="*" type="file" multiple
                       ...
                       title=""
                       x-ref="attachedFiles"
                       wire:model.live="attached_files"/>
                ...
                <div class="grid grid-cols-2 gap-4 mt-4 md:grid-cols-6" @drop.prevent="drop($event)"
                    ...
                    <template x-for="(_, index) in Array.from({ length: files.length })">
                        <div class="relative flex flex-col items-center overflow-hidden text-center bg-neutral border rounded cursor-move select-none"
                            ...
                            <button class="absolute top-0 right-0 z-50 p-1 bg-secondary rounded-bl focus:outline-none"
                            ...
                            <div class="absolute bottom-0 left-0 right-0 flex flex-col p-2 text-xs bg-secondary bg-opacity-50">
                                ...
                                <span class="text-xs text-dark-text-color"
