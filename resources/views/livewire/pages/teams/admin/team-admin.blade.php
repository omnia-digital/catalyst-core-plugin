    ...
    <div class="">
        ...
        <div x-data="setup()" class="px-4 pb-20">
                    ...
                    <div class="flex-col space-y-4">
                        ...
                        <div class="flex justify-between items-center relative min-w-0 w-full border-gray-300 placeholder-gray-500 bg-secondary rounded focus:ring-primary focus:border-primary text-sm p-2">
                            ...
                            <label>
                                ...
                                <span class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white-text-color bg-primary-500
                                hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-light focus:ring-primary">Change</span>
                            </label>
                        </div>
            ...
            <div x-cloak x-show="activeTab === 2" class="mt-6 pb-12 space-y-6">
                <div>
                    <livewire:catalyst::pages.teams.admin.manage-team-members :team="$team"/>
                </div>
            </div>
            ...
            <div x-cloak x-show="activeTab === 3" class="mt-6 pb-12 space-y-6">
                <div>
                    <livewire:catalyst::pages.teams.admin.manage-team-forms :team="$team"/>
                </div>
            </div>
