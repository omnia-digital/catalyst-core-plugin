<x-library::modal id="create-team">
    <x-slot name="title">{{ Translate::get('Create Team') }}</x-slot>
    ...
    <x-slot name="content">
        <div>
            ...
            <x-library::input.text wire:model.live="name" class="bg-secondary"
                                   placeholder="{{ Translate::get('Enter your Team Name') }}" required/>
        ...
        {{--            <div class="flex items-center">--}}
        {{--                <x-library::input.label value="{{ \Translate::get('Team Focus') }}" /><span class="text-red-600 text-sm ml-1">*</span>--}}
        {{--            </div>--}}
        {{--            <p class="text-neutral-dark">{{ \Translate::get('Do you want this Team to be focused on something?') }}</p>--}}
        ...
        {{--            </div>--}}
        {{--            <x-library::input.date wire:model.live="startDate" placeholder="{{ \Translate::get('Team Launch Date') }}"/>--}}
