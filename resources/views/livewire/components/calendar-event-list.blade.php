<div class="h-full min-w-[295px] max-w-[395px] p-2 {{ $classes }}">
    <div x-data="{
        ...
        "
         x-on:select-event.window="selectEvent($event.detail.event);"
        ...
        <div class="h-full flex flex-col">
            <div class="bg-secondary flex justify-between items-center text-xl min-h-[64px] pt-2 px-4">
                <div class="font-medium">
                    <div class="text-xl" x-show="!showDetail">{{ Translate::get('Events') }}</div>
...
{{--                    </a>--}}
            ...
            <div x-show="!showDetail">
                @include('catalyst::livewire.partials.filters-sm', ['skipFilters' => ['has_attachment']])
            </div>
                    ...
                    >
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <p>{{ $item->starts_at?->toFormattedDateString() }}</p>
                            </div>
                        </div>
                    </div>
                @empty
                    <div>No {{ \OmniaDigital\CatalystCore\Facades\Translate::get('Events') }} to show</div>
                @endforelse
            </div>
            ...
            <div x-cloak x-show="showDetail"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-6 flex items-center justify-center bg-secondary">
                    <div wire:loading wire:target="selectEvent" class="absolute inset-0 bg-white/75"></div>
