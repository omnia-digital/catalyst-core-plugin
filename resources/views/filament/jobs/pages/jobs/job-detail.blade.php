...
@section('content')
    <div>
        ...
        <div class="">
                            ...
                            <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
                                ...
                                <div class="mt-2 ml-2 flex items-center text-sm leading-5 text-gray-500">
                                    @foreach ($job->skills->pluck('name') as $skill)
                                        <x-catalyst::tag :name="$skill"
                                                         class="bg-teal-100 text-teal-800 rounded-full text-sm ml-2"/>
                                    @endforeach
                                </div>
                            </div>
                        </div>
            ...
            <x-catalyst::jobs.tooltip
                    trigger="payment-type-budget">{{ Translate::get('Payment Type & Budget') }}</x-catalyst::jobs.tooltip>
            <x-catalyst::jobs.tooltip
