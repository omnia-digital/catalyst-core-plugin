                ...
                <button class="accordion-button
                    ...
                    <div>
                        <div class="flex items-center space-x-6">
                            ...
                            {{--                                    <button type="button" class="inline-flex items-center px-4 py-2 rounded-full bg-primary-500 text-white-text-color text-sm tracking-wide font-medium hover:opacity-75">--}}
                            {{--                                        <span>Follow</span>--}}
                            {{--                                    </button>--}}
                            {{--                                </div>--}}
                        </div>
