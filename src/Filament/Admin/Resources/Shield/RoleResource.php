...
class RoleResource extends ShieldRoleResource implements HasShieldPermissions
{
    ...
    {
        return [
            'index' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\RoleResource\Pages\ListRoles::route('/'),
            'create' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\RoleResource\Pages\CreateRole::route('/create'),
            'view' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\RoleResource\Pages\ViewRole::route('/{record}'),
            'edit' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\RoleResource\Pages\EditRole::route('/{record}/edit'),
        ];
    }
