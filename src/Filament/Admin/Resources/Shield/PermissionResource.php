...
namespace OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield;
...
class PermissionResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return [
            'index' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\PermissionResource\Pages\ListPermissions::route('/'),
            'create' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\PermissionResource\Pages\CreatePermission::route('/create'),
            'view' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\PermissionResource\Pages\ViewPermission::route('/{record}'),
            'edit' => \OmniaDigital\CatalystCore\Filament\Admin\Resources\Shield\PermissionResource\Pages\EditPermission::route('/{record}/edit'),
        ];
    }
